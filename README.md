...
## <a name='whitespace'>Whitespace</a>
  ...
  - Place an empty newline at the end of the file.
    ...
    ```
 >  This is useful while concatanation of two or more files. For more information [go here.](http://evanhahn.com/newline-necessary-at-the-end-of-javascript-files/)
...
## <a name='type-coercion'>Type Casting & Coercion</a>
  ...
  - **Note:** Be careful when using bitshift operations. Numbers are represented as [64-bit values](http://es5.github.io/#x4.3.19), but Bitshift operations always return a 32-bit integer ([source](http://es5.github.io/#x11.7)). Bitshift can lead to unexpected behavior for integer values larger than 32 bits.
